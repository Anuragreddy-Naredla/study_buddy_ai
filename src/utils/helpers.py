...
def rerun():
    #This will trigger the streamlit app to rerun while changing the session state
...
class QuizManager:
    def __init__(self):
        ...
        self.user_answers=[]
        self.results=[]
    def generate_questions(self,generator:QuestionGenerator,topic:str,question_type:str,difficulty:str,num_of_questions:int):
        self.questions=[]
        self.user_answers=[]
        self.results=[]
    ...
    def attempt_quiz(self):
        """Whenever user attempts any questions all the questions will be recorded here.
        """
    ...
    def save_to_csv(self,filename_prefix="quiz_results"):
        ...
        try:
            ...
            st.error(f"Failed to save the results {e}")
            return None
